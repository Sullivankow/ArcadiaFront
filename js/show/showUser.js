...
async function editUser() {
  const newRole = prompt(
    "Entrez le nouveau rôle pour cet utilisateur (laissez vide pour ne pas modifier) :"
  );
  const newUsername = prompt(
    "Entrez le nouveau mail pour cet utilisateur (laissez vide pour ne pas modifier) :"
  );
